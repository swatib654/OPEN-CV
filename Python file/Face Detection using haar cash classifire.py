...
# Load the Haar Cascade for face dectition
face_classifier = cv2.CascadeClassifier(r"C:\Users\pc\OneDrive\Desktop\Deep Learning\Open CV\haarcascade_eye.xml")

# load the image
image = cv2.imread(r"C:\Users\pc\OneDrive\Desktop\Deep Learning\Open CV\Rashmika1.jpeg")
